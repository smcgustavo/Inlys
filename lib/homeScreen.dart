          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  indicator("Dólar", "R\$5,43", "0.32%", Icons.trending_up, Colors.greenAccent),
                  indicator("Ibovespa", "101.785", "0.55%", Icons.trending_up, Colors.greenAccent)
                ],
              ),
            ),
            Padding(
            ...
            Padding(
                ...
                child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => SearchStock(allStocks: allStocks))
                      );
                    },
